					...
					<form class="form-horizontal" role="form" id="miform" enctype="multipart/form-data">
						<div class="modal-body">
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" name="nombres" id="nombres" class="form-control campo" placeholder="Nombres del cliente" required>
								</div>
							</div>
							<div class="form-group row">
								<label for="apellidos" class="col-sm-4 col-form-label">Apellidos:</label>
								<div class="col-sm-8">
									<input type="text" name="apellidos" id="apellidos" class="form-control campo" placeholder="Apellidos del cliente" required>
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" name="dui" id="dui" class="form-control campo" placeholder="DUI" >
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" name="correo" id="correo" class="form-control campo" placeholder="Ejm: cliente@gmail.com">
								</div>
							</div>
							<div class="form-group row">
...
<!-- jQuery Y--> <!-- Bootstrap 4 -->
  ...
  <script type="text/javascript">
    ...
    $.ajax({
      dataType: "json",
      url:"<?php echo controlador::$rutaAPP?>index.php?action=getpersona",
      data:{op:4,id:id},
      type:'POST',
